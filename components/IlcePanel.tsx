            ...
            <div className="flex flex-col gap-3 px-4">
              {mahalleler.length === 0 ? (
                ...
                mahalleler.map((mahalle, idx) => (
                  <div
                    key={idx}
                    className="pl-12 pr-4 py-1.5 rounded-lg bg-amber-100/90 border-2 border-amber-400/70 hover:bg-amber-200/90 hover:border-amber-500 hover:shadow-md transition-all text-gray-800 whitespace-nowrap cursor-pointer"
                    style={{ fontSize: '13px' }}
                  >
                    {mahalle.mahalle_adi}
                  </div>
              ...
              {ilceler.length === 0 ? (
                ...
                ilceler.map((ilce, idx) => (
                  <button
                    ...
                    className="pl-12 pr-4 py-1.5 rounded-lg bg-amber-100/90 border-2 border-amber-400/70 hover:bg-amber-200/90 hover:border-amber-500 hover:shadow-md transition-all text-left flex items-center gap-2 group whitespace-nowrap"
                  >
