...
-- KONYA İlçeleri
INSERT INTO ilceler (sehir_id, ilce_adi)
SELECT id, unnest(ARRAY['Ahırlı', 'Akören', 'Akşehir', 'Altınekin', 'Beyşehir', 'Bozkır', 'Cihanbeyli', 'Çeltik', 'Çumra', 'Derbent', 'Derebucak', 'Doğanhisar', 'Emirgazi', 'Ereğli', 'Güneysınır', 'Hadim', 'Halkapınar', 'Hüyük', 'Ilgın', 'Kadınhanı', 'Karapınar', 'Karatay', 'Kulu', 'Meram', 'Sarayönü', 'Selçuklu', 'Seydişehir', 'Taşkent', 'Tuzlukçu', 'Yalıhüyük', 'Yunak'])
FROM iller WHERE sehir_adi = 'Konya';

-- KÜTAHYA İlçeleri
INSERT INTO ilceler (sehir_id, ilce_adi)
SELECT id, unnest(ARRAY['Altıntaş', 'Aslanapa', 'Çavdarhisar', 'Domaniç', 'Dumlupınar', 'Emet', 'Gediz', 'Hisarcık', 'Merkez', 'Pazarlar', 'Simav', 'Şaphane', 'Tavşanlı'])
...
-- MUĞLA İlçeleri
INSERT INTO ilceler (sehir_id, ilce_adi)
SELECT id, unnest(ARRAY['Bodrum', 'Dalaman', 'Datça', 'Fethiye', 'Kavaklıdere', 'Köyceğiz', 'Marmar', 'Menteşe', 'Milas', 'Ortaca', 'Seydikemer', 'Ula', 'Yatağan'])
...
-- TRABZON İlçeleri
INSERT INTO ilceler (sehir_id, ilce_adi)
SELECT id, unnest(ARRAY['Akçaabat', 'Araklı', 'Arsin', 'Beşikdüzü', 'Çarşıbaşı', 'Çaykara', 'Dernekpazarı', 'Düzköy', 'Hayrat', 'Köprübaşı', 'Maçka', 'Of', 'Ortahisar', 'Sürmene', 'Şalpazarı', 'Tonya', 'Vakfıkebir', 'Yomra'])
...
-- YOZGAT İlçeleri
INSERT INTO ilceler (sehir_id, ilce_adi)
SELECT id, unnest(ARRAY['Akdağmadeni', 'Aydıncık', 'Boğazlıyan', 'Çandır', 'Çayıralan', 'Çekerek', 'Kadışehri', 'Merkez', 'Saraykent', 'Sarıkaya', 'Şefaatli', 'Sorgun', 'Yenifakılı', 'Yerköy'])
...
-- Kontrol
SELECT
    'Toplam ilçe sayısı: ' || COUNT(*) as sonuc
FROM ilceler;
